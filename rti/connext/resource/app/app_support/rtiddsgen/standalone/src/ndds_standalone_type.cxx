    ...
    RTIBool reallocate)
{
    ...
    /*
     * Coverity shows a false positive in the following call see:
     * ROBUSTNESS-1178 for more information
    */
...
DDS_UnsignedLong DDS_Wstring_length(const DDS_Wchar* string) {
    const char *const FUNCTION_NAME = "DDS_Wstring_length";
    ...
    if (string == NULL) {
        DDSLog_logWithFunctionName(
                ...
                FUNCTION_NAME, &DDS_LOG_BAD_PARAMETER_s, "string");
        return 0;
    }
...
DDS_String_replace(char** string_ptr, const char* new_value) {
    ...
    const char *const FUNCTION_NAME = "DDS_String_replace";
    char* result = NULL;
    ...
    if (string_ptr == NULL) {
       DDSLog_logWithFunctionName(
                RTI_LOG_BIT_EXCEPTION,
                FUNCTION_NAME, &DDS_LOG_BAD_PARAMETER_s, "string_ptr");
       goto done; 
    }    
    ...
    /* Replace old value */    
       ...
       if (RTIOsapiHeap_reallocateString(string_ptr, strlen(new_value))) {              
          ...
          DDSLog_logWithFunctionName(
                RTI_LOG_BIT_EXCEPTION,
                FUNCTION_NAME, &DDS_LOG_OUT_OF_RESOURCES_s,
                          "reallocating string");           
       }       
    }
...
DDS_Wchar* DDS_Wstring_replace(DDS_Wchar** string_ptr,
    ...
    const char *const FUNCTION_NAME = "DDS_Wstring_replace";
