 ...
 *
 * Any operation can can throw one of the following "standard exceptions" unless
...
public:
    ...
    AlreadyClosedError& operator=(const AlreadyClosedError&);
...
public:
    ...
    IllegalOperationError& operator=(const IllegalOperationError&);
 ...
 *
 * @details 
 *          \dref_details_ReturnCode_t_RETCODE_NOT_ALLOWED_BY_SECURITY
 */
class OMG_DDS_API NotAllowedBySecurityError: public Exception, public std::logic_error {
public:
    explicit NotAllowedBySecurityError(const std::string& msg);
    NotAllowedBySecurityError(const NotAllowedBySecurityError& src);
    NotAllowedBySecurityError& operator=(const NotAllowedBySecurityError&);
    virtual ~NotAllowedBySecurityError() throw ();

    /**
     * @brief Access the message contained in this NotAllowedBySecurityError
     * exception.
     *
     * @return The message.
     */
...
public:
    ...
    ImmutablePolicyError& operator=(const ImmutablePolicyError&);
...
public:
    ...
    InconsistentPolicyError& operator=(const InconsistentPolicyError&);
...
public:
    ...
    InvalidArgumentError& operator=(const InvalidArgumentError&);
...
public:
    ...
    NotEnabledError& operator=(const NotEnabledError&);
...
public:
    ...
    OutOfResourcesError& operator=(const OutOfResourcesError&);
...
public:
    ...
    PreconditionNotMetError& operator=(const PreconditionNotMetError&);
...
public:
    ...
    TimeoutError& operator=(const TimeoutError&);
...
public:
    ...
    UnsupportedError& operator=(const UnsupportedError&);
...
/**
 * @brief Indicates that a downcast was incorrect.
 *
 * Inherits also from \p std::runtime_error
 *
...
public:
    ...
    InvalidDowncastError& operator=(const InvalidDowncastError&);
...
/**
 * @brief Indicates an attempt to access a null object.
 */
...
public:
    ...
    NullReferenceError& operator=(const NullReferenceError&);
...
public:
    ...
    InvalidDataError& operator=(const InvalidDataError&);
